...
import static net.evercode.lawfirm.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import net.evercode.lawfirm.config.Constants;
import net.evercode.lawfirm.domain.User;
import net.evercode.lawfirm.repository.AuthorityRepository;
import net.evercode.lawfirm.repository.UserRepository;
import net.evercode.lawfirm.security.AuthoritiesConstants;
import net.evercode.lawfirm.service.UserService;
import net.evercode.lawfirm.service.dto.AdminUserDTO;
import net.evercode.lawfirm.service.dto.PasswordChangeDTO;
import net.evercode.lawfirm.service.dto.UserDTO;
import net.evercode.lawfirm.web.rest.vm.KeyAndPasswordVM;
import net.evercode.lawfirm.web.rest.vm.ManagedUserVM;
