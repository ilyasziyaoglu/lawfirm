...
class EmployeesResourceIT {
    ...
    void createEmployees() throws Exception {
        ...
        assertThat(testEmployees.getImageName()).isEqualTo(DEFAULT_IMAGE_NAME);
    ...
    @Test
    @Transactional
    void getAllEmployeesByImageNameIsEqualToSomething() throws Exception {
        // Initialize the database
        employeesRepository.saveAndFlush(employees);

        // Get all the employeesList where imageName equals to DEFAULT_IMAGE_NAME
        defaultEmployeesShouldBeFound("imageName.equals=" + DEFAULT_IMAGE_NAME);

        // Get all the employeesList where imageName equals to UPDATED_IMAGE_NAME
        defaultEmployeesShouldNotBeFound("imageName.equals=" + UPDATED_IMAGE_NAME);
    }

    @Test
    @Transactional
    void getAllEmployeesByImageNameIsNotEqualToSomething() throws Exception {
        // Initialize the database
        employeesRepository.saveAndFlush(employees);

        // Get all the employeesList where imageName not equals to DEFAULT_IMAGE_NAME
        defaultEmployeesShouldNotBeFound("imageName.notEquals=" + DEFAULT_IMAGE_NAME);

        // Get all the employeesList where imageName not equals to UPDATED_IMAGE_NAME
        defaultEmployeesShouldBeFound("imageName.notEquals=" + UPDATED_IMAGE_NAME);
    }

    @Test
    @Transactional
    void getAllEmployeesByImageNameIsInShouldWork() throws Exception {
        // Initialize the database
        employeesRepository.saveAndFlush(employees);

        // Get all the employeesList where imageName in DEFAULT_IMAGE_NAME or UPDATED_IMAGE_NAME
        defaultEmployeesShouldBeFound("imageName.in=" + DEFAULT_IMAGE_NAME + "," + UPDATED_IMAGE_NAME);

        // Get all the employeesList where imageName equals to UPDATED_IMAGE_NAME
        defaultEmployeesShouldNotBeFound("imageName.in=" + UPDATED_IMAGE_NAME);
    }

    @Test
    @Transactional
    void getAllEmployeesByImageNameIsNullOrNotNull() throws Exception {
        // Initialize the database
        employeesRepository.saveAndFlush(employees);

        // Get all the employeesList where imageName is not null
        defaultEmployeesShouldBeFound("imageName.specified=true");

        // Get all the employeesList where imageName is null
        defaultEmployeesShouldNotBeFound("imageName.specified=false");
    }

    @Test
    @Transactional
    void getAllEmployeesByImageNameContainsSomething() throws Exception {
        // Initialize the database
        employeesRepository.saveAndFlush(employees);

        // Get all the employeesList where imageName contains DEFAULT_IMAGE_NAME
        defaultEmployeesShouldBeFound("imageName.contains=" + DEFAULT_IMAGE_NAME);

        // Get all the employeesList where imageName contains UPDATED_IMAGE_NAME
        defaultEmployeesShouldNotBeFound("imageName.contains=" + UPDATED_IMAGE_NAME);
    }

    @Test
    @Transactional
    void getAllEmployeesByImageNameNotContainsSomething() throws Exception {
        // Initialize the database
        employeesRepository.saveAndFlush(employees);

        // Get all the employeesList where imageName does not contain DEFAULT_IMAGE_NAME
        defaultEmployeesShouldNotBeFound("imageName.doesNotContain=" + DEFAULT_IMAGE_NAME);

        // Get all the employeesList where imageName does not contain UPDATED_IMAGE_NAME
        defaultEmployeesShouldBeFound("imageName.doesNotContain=" + UPDATED_IMAGE_NAME);
    }
    ...
    void putNewEmployees() throws Exception {
        ...
        assertThat(testEmployees.getImageName()).isEqualTo(UPDATED_IMAGE_NAME);
    ...
    void partialUpdateEmployeesWithPatch() throws Exception {
        ...
        partialUpdatedEmployees.name(UPDATED_NAME).surname(UPDATED_SURNAME).story(UPDATED_STORY).imageName(UPDATED_IMAGE_NAME);
