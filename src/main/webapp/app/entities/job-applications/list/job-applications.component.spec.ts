...
describe('JobApplications Management Component', () => {
  let comp: JobApplicationsComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'job-applications', component: JobApplicationsComponent }]),
      ...
      .overrideTemplate(JobApplicationsComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.jobApplications?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
