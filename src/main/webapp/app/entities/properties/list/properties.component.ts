...
export class PropertiesComponent implements OnInit {
  ...
  constructor(protected propertiesService: PropertiesService, protected modalService: NgbModal, protected parseLinks: ParseLinks) {
    this.properties = [];
  ...
  loadAll(): void {
    ...
    this.propertiesService
      ...
      .subscribe({
        next: (res: HttpResponse<IProperties[]>) => {
          this.isLoading = false;
          this.paginateProperties(res.body, res.headers);
        },
        error: () => {
          this.isLoading = false;
        },
  ...
  protected paginateProperties(data: IProperties[] | null, headers: HttpHeaders): void {
